...
// internamente, objetos literais viram funÃ§oes explicitas
console.log('new Object() is {}? ', new Object().__proto__ === {}.__proto__)
assert.deepStrictEqual(new Object().__proto__, {}.__proto__)

// __proto__ Ã© a referencia do objeto que possui as propriedades nele
...
//  o __proto__ de Object.prototype Ã© null
...
Employee.prototype.salary = function(){
  return `name: ${this.name} salary: 0.0**`
}
...
// podemos chamar via prototype, mas se tentar chamar direto dÃ¡ erro!
...
const manager = new Manager("Tiago") 
...
const emp = new Employee("Tiago")
console.log('-----')
console.log('manager: ', emp.salary())
