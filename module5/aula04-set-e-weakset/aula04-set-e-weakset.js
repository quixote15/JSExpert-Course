...
// console.log('set.values', set.values()) // sÃ³ existe por conta do Map

// no Array comum, para saber se um item existe
// [].indexOf('1') !== -1 ou [0].includes(0)
assert.ok(set.has('3'))

// mesma teoria do Map, mas vocÃª sempre trabalha com a lista toda
// nao tem get, entao vocÃª pode saber se o item estÃ¡ ou nao no array e Ã© isso.
// na documentaÃ§Ã£o tem exemplos sobre como fazer uma interceÃ§ao, saber o que tem em uma lista e nao
...
// nao Ã© enumerÃ¡vel (iterÃ¡vel)
// sÃ³ trabalha com chaves como referencia
// sÃ³ tem metodos simples
