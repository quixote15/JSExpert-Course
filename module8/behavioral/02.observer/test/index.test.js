...
describe('Test Suite Observable Pattern', () => {
  beforeAll(() => {
    jest.spyOn(console, console.log.name).mockImplementation(() => {}); // hack to log nothing
  })
  ...
  test('#Payment should notify subject after a credit card transaction', () => {
    ...
    const data = {userName: 'Tiago Santos', id: Date.now()};
